                                        ...
                                        <div class="ck-book <?php if ($coming_soon == "ok") {
                                                        ...
                                                        <div class="ck-old-price">
                                                            <?php if (((1 - ((int)($final_price) / (int)($regular_price))) * 100) != 0) { ?>
                                                                ...
                                                                if ($product->is_type('variable')) {
                                                                    ...
                                                                    ?>
                                                                    <del>
                                                                        <h3><?php echo number_format($product->get_regular_price()); ?>
                                                                            تومان</h3></del>
                                                                <?php } ?>
                                            ...
                                            <?php if ($product->is_in_stock()) { ?>
                                                ...
                                                if ($product->is_type('variable')) {
                                                    ...
                                                    <div rel="<?php echo $loop->post->ID; ?>" class="single_add_to_cart_buttons text-center"><?php echo $att?></div>
                                                <?php } ?>
                                            <?php } else { ?>
