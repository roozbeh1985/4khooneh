...
$porseh_motadavel="پرسش های متداول ".get_the_title($post->post_parent);
$filme_amozeshi="فیلم آموزشی ".get_the_title($post->post_parent);
$moshavere="مشاوره ".get_the_title($post->post_parent);
$khabarname="خبرنامه ";
$sargarmi="سرگرمی";



    $address_porsesh    =get_the_title($post->post_parent)."/".$porseh_motadavel;
    $address_film       =get_the_title($post->post_parent)."/".$filme_amozeshi;
    $address_moshavere  =get_the_title($post->post_parent)."/".$moshavere;
