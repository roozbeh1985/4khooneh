    ...
    <div class="menubar" id="menu">
            ...
            <ul class="nav">
                ...
                foreach ($menu_item as $x => $x_value) {
                    ...
                    <?php if ($menu_item[$menu1[$i]]["title"]) { ?>
                        <li>
                            <a href="<?php echo $menu_item[$menu1[$i]]["url"]; ?>"><?php echo $menu_item[$menu1[$i]]["title"]; ?></a>
                            <div class="layer2"
                                <?php
                                    ...
                                    <ul class="nav inner">
                                        ...
                                        foreach ($menu_item[$x]["children"] as $y => $y_value) {
                                            ...
                                            <li>
                                                ...
                                                <a href="<?php echo($menu_item[$x]["children"][$y]["url"]); ?>"><?php echo($menu_item[$x]["children"][$y]["title"]); ?></a>
                                                <?php if (($menu_item[$menu1[$i]]["title"] == "هنرستان") || ($menu_item[$menu1[$i]]["title"] == "کارشناسی ناپیوسته") || ($menu_item[$menu1[$i]]["title"] == "آزمون آنلاین")) { ?>
                                                    <?php if ($menu_item[$ssm]["children"]) { ?>
                                                        <?php foreach ($menu_item[$ssm]["children"] as $y2 => $y2_value) {
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="<?php echo($menu_item[$ssm]["children"][$y2]["url"]); ?>"><?php echo($menu_item[$ssm]["children"][$y2]["title"]); ?></a>
                                                                </li>
                                                            </ul>
                                                        <?php } ?>
                                                    <?php } ?>
        ...
        <div class="ck-seach-container">
            ...
            <div class="ck-search-form">
                <input id="ry-key" class="form-control ry-search-input float-right ry-search-form-header form-control"
                       type="text"
            ...
            foreach ($menu_item as $x => $x_value) {
                ...
                <?php if ($menu_item[$menu1[$i]]["title"]) { ?>
                    <li class="ck-first"><a href="#"><i class="fa fa-angle-down ck-halat ck-<?php echo $i; ?>"
                                                        aria-hidden="true"></i><?php echo $menu_item[$menu1[$i]]["title"]; ?>
                            <i class="fa fa-circle ck-<?php echo $i; ?>" aria-hidden="true"></i></a>
                        <ul class="ck-menu-level2-container">
                            <?php
                            foreach ($menu_item[$x]["children"] as $y => $y_value) {
                                $sub_menu1[$n] = $y;
                                ?>
                                <li class="ck-menu-level2"><a
                                        href="<?php echo($menu_item[$x]["children"][$y]["url"]); ?>"><?php echo($menu_item[$x]["children"][$y]["title"]); ?>
                                        <i class="fa fa-circle ck-<?php echo $i; ?>" aria-hidden="true"></i></a></li>
                                <?php $ssm = ($menu_item[$x]["children"][$y]["ID"]); ?>
                                <?php if (($menu_item[$menu1[$i]]["title"] == "هنرستان") || ($menu_item[$menu1[$i]]["title"] == "کارشناسی ناپیوسته")) { ?>
                                    ...
                                    <?php if ($menu_item[$ssm]["children"]) { ?>
                                        <?php foreach ($menu_item[$ssm]["children"] as $y2 => $y2_value) {
                                            ...
                                            <ul class="ck-">
                                                <li>
                                                    <a href="<?php echo($menu_item[$ssm]["children"][$y2]["url"]); ?>"><?php echo($menu_item[$ssm]["children"][$y2]["title"]); ?>
                                                        <i class="fa fa-circle ck-<?php echo $i; ?>"
