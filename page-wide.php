                                            ...
                                            <div class="ck-gheymat">
                                                <?php if ($product->is_in_stock()) {
                                                    ...
                                                    <div class="ck-old-price">
                                                        <del><h3><?php echo $product->get_regular_price(); ?>تومان</h3>
                                                        </del>
                                                    </div>
                                                    <div class="ck-new-price"><h3><?php echo $product->get_price(); ?>
                                                            تومان</h3>
                                                    </div>
                                                <?php } else { ?>
                                    ...
                                    <div class="swiper-container1" dir="rtl">
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            if ($result->num_rows > 0) {
                                                ...
                                                ?>
                                                <div class="swiper-slide lazy "><a
                                                        href="<?php bloginfo('url') ?>/product/<?php echo $href; ?>"><img
