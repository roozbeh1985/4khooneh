                    ...
                    <div class="row" dir="rtl">
                        ...
                        <article class="ck-page-article">
                            ...
                            foreach ($film_kind as $fk) {
                                ...
                                $zz++; ?>">
                                    <h1 class="text-center ry-hedear-filmss"><span
                                                class="ry-danger"><?php echo $fk ?></span></h1>
                                    <?php
                                    ...
                                    while ($loop->have_posts()) : $loop->the_post();
                                        ...
                                        $sex=get_post_meta($post->ID, 'جنسیت', true);
                                        ?>
                                        ...
                                        <div class="ck-book ry-fiilllmm <?php if ($coming_soon == 'ok') {
                                            ...
                                            <a href="<?php if ($coming_soon != "ok") {
                                                ...
                                                <?php if ($sex) { ?>
                                                    <span class="ry-bargain <?php if ($sex=='دخترانه') echo 'ry-dokhtar';elseif ($sex=='مختلط') echo 'ry-mokhtalet';else echo 'ry-pesar';?> "><?php echo $sex?></span>
                                                <?php } ?>
                                                <?php
