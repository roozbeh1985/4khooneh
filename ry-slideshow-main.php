...
<div class="section ry-mm-s" >
    <div class="swiper-container swiper-container1" dir="rtl">
        <div class="swiper-wrapper">
            ...
            foreach ($afff as $ff) {
                ?>
                <div  class="swiper-slide lazy "><a href="<?php bloginfo('url') ?>/<?php echo $ff[2]?>"><img alt="<?php echo $ff[0]?>" src="<?php bloginfo('url'); ?>/<?php echo $ff[1]?>"></a></div>
            <?php
            }
            ?>
        </div>
